 ...
 * @author Nop
 */
public class NGPTFlagEncoder extends AbstractFlagEncoder {
    ...
    public NGPTFlagEncoder() {
        this(new PMap());
    }

    public NGPTFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
        this(new PMap().putObject("speed_bits", speedBits).putObject("speed_factor", speedFactor).
                putObject("max_turn_costs", maxTurnCosts));
    }

    public NGPTFlagEncoder(PMap properties) {
    ...
    public NGPTFlagEncoder setSpeedTwoDirections(boolean value) {
    ...
    // IMPORTANT: BUS LANES OPPOSITE TO ONEWAY HERE!!
    protected boolean isOneway(ReaderWay way) {
        return ((way.hasTag("oneway", oneways) && !(way.hasTag("busway", "opposite_lane")))
